...
public class VideoMessageBody extends MessageBody {
	...
	public VideoMessageBody(String targetType, String[] targets, String from, Map<String, Object> ext, String url, String filename, String secret, Long length, Long fileLength,
